...
let title = "Fofana khó chịu vì không được ra đi"
let descripe = "Hậu vệ của Leicester hiện đang cảm thấy bức rức bởi đội nhà không muốn bán anh cho Chelsea."
const Newfeed = () => {
  return (
    <>
            ...
            <>
              <div key={index} className={styles["new-news"]}>
                ...
                <Row className={styles["news-content"]}>
                  ...
                  <Col md={20}>
                    <p>{maxLengthText(item.description,150)}</p>
                  </Col>
                </Row>
              </div>
