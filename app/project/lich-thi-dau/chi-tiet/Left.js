import { FootballTeam, MatchFootBall, stepMatch } from "@function/constant";
      ...
      <div className="detail-schedule-style-left-input">
        ...
        <div className="teamOne">
          ...
          <div className="team">
            ...
            {FootballTeam.teamOne?.arrGoal?.map((val,idx) => (
        ...
        <div className="teamOne">
          ...
          <div className="total">
              {
                `${FootballTeam.teamOne.total} - ${FootballTeam.teamTwo.total}`
              }
          </div>
          <div className="total-footer"> 
          {
            FootballTeam.inMatch?.map((val,idx) => (
              <p key={idx}>{`${val.title} : ${val.teamOne} - ${val.teamTwo}`} </p>
            ))
              } 
          </div>
        ...
        <div className="teamOne">
          ...
          <div className="team">
            <div className="title">
              <label>
                {FootballTeam.teamTwo.title}
              </label>
              <img className="logo" src={FootballTeam.teamOne.logo} />
            </div>
          <div className="item-info">
          {FootballTeam.teamTwo?.arrGoal?.map((val,idx) => (
              <div className="info" key ={idx}>
              <label>
                {`(${val.minute}') - ${val.name}`}
              </label>
