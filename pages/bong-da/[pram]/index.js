...
import { listDataOther, menuTabFootballParam } from "../../../app/@function/constant";
  ...
  return (
    <div className="body">
      ...
      <div className={styles.menutab}>
        {menuTabFootballParam.map((val, idx) => {
          return (
            <Link key={idx} href={"/bong-da/" + val.path}>
              <a>
                <div
                  className={
                    styles.menutabitem +
      ...
      <div className={styles.menutabBatter}>
        {menuTabFootballParam.filter((val) => val.path === route.query.pram).length
          ? menuTabFootballParam
