...
import { getListBackstage, getListWatchMore } from "../../stores/hautruong";

const ContainerHeight = 400;

const SportBackstageInfo = ({ listBackstage, listWatchMore }) => {
  const [data, setData] = useState(listBackstage ?? []);
  ...
  return (
    <div className="body">
      ...
      <h2 className="title-heading">Hậu trường</h2>
      <Divider />
      <Row gutter={20}>
        <Col md={16}>
...
export default SportBackstageInfo;
