        ...
        <div className="schedule-style-left">
          <div className="detail-schedule-style-left-week">
            <div className="menu-nav">
              <span>LTĐ</span> {">"}{" "}
              <span className="link">Trận đấu quan tâm</span>
              <div
                style={{
                  color: "#324a75",
                  fontWeight: "900",
            ...
            <div className="menu-to-me">
                {
                  menu.map((val, idx) => {
                    return <Link key={idx} href={val.to}><div className={" menu-to-me-item " + (router.asPath === val.to ? "menu-to-me-item-checked" : "" ) }>{val.title}</div></Link>
                  })
                }
            </div>
          </div>
...
export default MatchOfInterest;
