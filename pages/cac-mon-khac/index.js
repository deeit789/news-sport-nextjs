...
import { getListOtherSports, getListWatchMore } from "../../stores/cacmonkhac";

const ContainerHeight = 400;

const SportOtherSubjects = ({ listOtherSports, listWatchMore }) => {
  const [data, setData] = useState(listOtherSports ?? []);
...
export const getStaticProps = async () => {
  const listOtherSports = await getListOtherSports();
